...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Drawer Menu */}
      <div
        className={`fixed top-[73px] left-0 w-full h-[calc(100vh-73px)] bg-dark-bg/95 backdrop-blur-lg border-t border-white/5 transition-all duration-300 z-40 md:hidden flex flex-col justify-between py-12 px-8 ${
            ...
            return (
              ...
              >
                <Link
                  ...
                  className={`text-2xl font-bold tracking-wide transition-colors duration-300 block ${
                    isActive
                      ? 'text-neon-green'
                      : link.name === 'Stdio BD'
                      ? 'text-white'
